...
public class Assignment_IO
{
    ...
    {
        FileReader reader = new FileReader("C:\\Users\\MC\\projectOOP\\src\\forFINAL\\Lecture19_FileIO\\Lecture19_FileIO\\Assignment_IO.txt");
        BufferedReader bufferedReader = new BufferedReader(reader);

        double sum = 0;

        String str = bufferedReader.readLine(); //reading all
        while (str != null)  //going until null
        {
