...
class  Implementation implements InterfaceClass //methode must be overridden to get rid of error
{
    @Override
...
interface Flyable    //attributes are by default :  public, static and final
{
    String media = "Sky";
    void fly();
    boolean needFuel();
